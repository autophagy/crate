...
public class CreateAlterTableStatementAnalyzerTest extends CrateDummyClusterServiceUnitTest {
    ...
    @Test
    public void test_length_is_required_for_bit_type() throws Exception {
        // varying bit is not implemented yet
        assertThrows(IllegalArgumentException.class, () -> analyze("CREATE TABLE tbl (xs bit)"));
    }
}
